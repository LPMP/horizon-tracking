...
struct FMC_HORIZON_TRACKING { // equivalent to SRMP or TRWS
   ...
   using max_factor_container = FactorContainer<max_factor, FMC_HORIZON_TRACKING, 2, false>;
   ...
   using FactorList = meta::list< UnaryFactor, PairwiseFactor, max_factor_container >;
   ...
   using horizon_tracking_constructor<mrf, max_factor_container, pairwise_max_message_container>;
